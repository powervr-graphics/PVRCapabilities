...
struct SCapabilities {
	...
	static bool DetermineGPUCapabilities(const std::string& renderer_string, SCapabilities& capabilities) {
		...
		static const std::unordered_map<std::string, SCapabilities> gpu_models {
			...
			// PowerVR Series7XT
			{ "GT7200", { Family::SERIES7XT, 256,  128,  4,  CAP_FP16 | CAP_TESSELLATION } },
			{ "GT7400", { Family::SERIES7XT, 512,  256,  8,  CAP_FP16 | CAP_TESSELLATION } },
			{ "GT7600", { Family::SERIES7XT, 768,  384,  12, CAP_FP16 | CAP_TESSELLATION } },
			{ "GT7800", { Family::SERIES7XT, 1024, 512,  16, CAP_FP16 | CAP_TESSELLATION } },
			{ "GT7900", { Family::SERIES7XT, 2048, 1024, 32, CAP_FP16 | CAP_TESSELLATION } },
			// PowerVR Wizard
